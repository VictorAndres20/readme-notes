...
implementation
```
import 'package:pcat/src/_config/api.dart';
import 'package:pcat/src/_services/generic.service.dart';

bool isHttps = false;

const String basePath = 'results';

Future<Map<String, dynamic>> createResults(Map<dynamic, dynamic> body) async {
